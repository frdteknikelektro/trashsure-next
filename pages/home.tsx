...
const Home = () => {
    ...
    return (
        <div className="HomeNewUser flex flex-col w-full bg-green-700">
            ...
            <div className="BaseProfile z-10 mx-6 mt-6 justify-start items-center gap-5 flex">
                <div className="Frame2 justify-start items-center gap-5 flex">
                    <div className="BaseProfile w-10 h-10 justify-center items-center flex">
                        <img className="Ellipse4 w-10 h-10 rounded-full" src={data?.user?.image || ''} />
                    </div>
            ...
            <div className="CardPreBuild z-10 p-3.5 mx-6 mt-6 bg-white rounded-lg flex-col justify-start items-start gap-3.5 inline-flex">
